(function () {
  ...
  function buildCards() {
    ...
    for (var i = 0; i < CARD_COUNT; i++) {
      ...
      imageOuter.className = "values-card-image-outer";
      var imageWindow = document.createElement("div");
      imageWindow.className = "values-card-image-window";
      ...
      imageOuter.appendChild(imageWindow);
      var footer = document.createElement("div");
      footer.className = "values-card-footer";
      var footerLabel = document.createElement("span");
      footerLabel.className = "values-card-footer-label";
      footerLabel.textContent = value.name;
      var footerCode = document.createElement("span");
      footerCode.className = "values-card-footer-code";
      footerCode.textContent = "#" + ("0" + (i + 1));
      footer.appendChild(footerLabel);
      footer.appendChild(footerCode);
      frontInner.appendChild(imageOuter);
      frontInner.appendChild(footer);
